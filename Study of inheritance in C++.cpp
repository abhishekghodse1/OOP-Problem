//Program : Write a program in C++ to Read and Display the information of Employee Using Multiple Inheritance. Use Basic Info and Department Info as a base classes of Employee class. 
